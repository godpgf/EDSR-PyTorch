...
python main.py --model DFEQE --scale 2 --compress 3 --n_feats 72 --epochs 1200 --patch_size 96 --save dfeqe_baseline_x2_distilling --reset --distilling --pre_train ../experiment/dfeqe_baseline_x2/model/model_best.pt
