...
# DFEQE
python main.py --model DFEQE --scale 2 --patch_size 96 --save dfeqe_baseline_x2 --reset
python main.py --model DFEQE --scale 4 --patch_size 96 --save dfeqe_baseline_x4 --reset --pre_train ../experiment/dfeqe_baseline_x2/model/model_best.pt
python main.py --model DFEQE --scale 4 --patch_size 96 --save dfeqe_baseline_x4_distilling --reset --distilling --pre_train ../experiment/dfeqe_baseline_x4/model/model_best.pt
