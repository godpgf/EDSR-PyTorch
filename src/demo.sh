...
python main.py --model FEQE --noise-type gaussian --noise-param 50 --scale 2 --compress 4 --n_feats 16 --epochs 300 --patch_size 96 --save feqe_baseline_x2 --reset --pre_train ../experiment/dfeqe_baseline_x2_distilling/model/model_latest.pt
python main.py --model FEQE --noise-type --data_train REALSR --data_test REALSR --data_range 1-500/501-506 --scale 2 --compress 4 --n_feats 16 --epochs 4 --patch_size 96 --save feqe_baseline_x2_denoise --reset --pre_train ../experiment/feqe_baseline_x2/model/model_latest.pt
