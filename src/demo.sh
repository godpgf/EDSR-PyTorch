...
python main.py --model FEQE --noise-type gaussian --scale 2 --compress 4 --n_feats 16 --epochs 300 --patch_size 96 --save feqe_baseline_x2_denoise --reset --pre_train ../experiment/dfeqe_baseline_x2_distilling/model/model_latest.pt
